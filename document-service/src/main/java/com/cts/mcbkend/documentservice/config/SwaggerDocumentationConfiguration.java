package com.cts.mcbkend.documentservice.config;
...
public class SwaggerDocumentationConfiguration {
	...
	public Docket createRestApi() {
		return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo())
				...
				.apis(RequestHandlerSelectors.basePackage("com.cts.mcbkend.documentservice"))
				.paths(PathSelectors.any()).build().pathMapping("/");
	}
	@Bean
	public Docket swaggerDocumentApi10() {
	    return new Docket(DocumentationType.SWAGGER_2)
	        .groupName("document-api-1.0")
	        .select()
	            .apis(RequestHandlerSelectors.basePackage("com.cts.mcbkend.documentservice"))
	            .paths(regex("/document/v1.0.*"))
	        .build()
	...
	public Docket swaggerDocumentApi11() {
	    return new Docket(DocumentationType.SWAGGER_2)
	        .groupName("document-api-1.1")
	        .select()
	            .apis(RequestHandlerSelectors.basePackage("com.cts.mcbkend.documentservice"))
	            .paths(regex("/document/v1.1.*"))
	        .build()
	...
	public Docket swaggerDocumentApi12() {
	    return new Docket(DocumentationType.SWAGGER_2)
	        .groupName("document-api-1.2")
	        .select()
	            .apis(RequestHandlerSelectors.basePackage("com.cts.mcbkend.documentservice"))
	            .paths(regex("/document/v1.2.*"))
	        .build()
